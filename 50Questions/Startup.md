...
# どういうスタートアップが多いの？
現在のエストニアのスタートアップは、1周目にeBayにExitして成功を収めたSkype、2周目にユニコーンとなったTransferwiseとして、3周目となるスタートアップをみんなで作ろうとしている印象です。
...
# スタートアップはどんな環境？
スタートアップの経営者にインタビューして、各々が人・金・場所が揃う最適な土壌という話をしていました。

**人**  
エストニアでは小学校からプログラミング教育が行われていたりリーダーシップ教育が行われています。なんと、一部の学校ではBitcoinのアプリ制作まで教えることもあるそうです。
- *TODO: StartupEstoniaの音声からリーダーシップ教育が始まるタイミングとその結果を出す*

更に、首都タリンにはタリン工科大学という優秀なエンジニアが多数集まる大学もあるため、スタートアップで必要な優秀な人材がいます。

また、Skypeマフィアたちが集まるLIFT99やオンラインのコミュニティで相談できるため、起業家コミュニティも存在しています。

**金**  
お金の面に関しても、前述したSkypeマフィアがスタートアップへ投資を行ったり、新たに創業するため資金についても比較的集めやすい環境です。
...
当初訪問するまでは、さぞ色々な国の人が集まっているんだろうと思っていましたが、意外にエストニアの人が多いんだなというのが印象的でした。

今回は7社のスタートアップのCEOに会いましたが、1社以外は全てエストニア人が代表でした。社員に関しては、10名以上いるようなチームであればイタリアやインドなどの国から来たというメンバーもいましたが、大半はエストニア人で構成されています。
